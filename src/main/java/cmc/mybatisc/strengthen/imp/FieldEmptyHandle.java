...
public class FieldEmptyHandle extends BaseStrengthen {
    ...
    public SqlParser createdSql(Method method) {
        ...
        NameConversion nameConversion = this.mybatiscConfig.getNameConversion();
        ...
        String collect = Arrays.stream(fieldEmpty.value()).map(s -> {
            String fieldName = tableAlias + "." + nameConversion.conversionFieldName(null,s.getValue().replaceAll(fieldEmpty.removeSuffix()+"$",""));
        ...
        for (Parameter parameter : parameters) {
            ...
            String fieldName = tableAlias + "." + nameConversion.conversionFieldName(null,generate.value.replaceAll(fieldEmpty.removeSuffix()+"$",""));
            // 判断是否是列表
